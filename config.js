...
module.exports = {
  ...
  author: process.env.author || "DILISHA TECH",
  //==========================================- API-CONFIGS -==========================================================
...
//------------------------------------------------------------------------------------------------------------------
  ...
  START_MSG: process.env.START_MSG || `🚀 *_DILISHA-MD Connected Successfully!_* ✅ 

--- *👨‍💻🎉 _Welcome to DILISHA-MD!_* 🎉💗 

*🔹 OWNER:* 94771098429

_Thank you for using_ *👨‍💻DILISHA-MD💗.*
...
*🖇️Subscribe My Youtube Channel✓💗 - :* https://www.youtube.com/@no1-AWM-FF

*🖇️Fork & Star My Repo✓💗 - :* https://github.com/DILISHA-MD

*🖇️Follow My Github Account✓💗 - :* https://github.com/DILISHA-MD

_*👨‍💻 Enjoy your time with us! 😊*_

> *©ᴘᴏᴡᴇʀᴇᴅ ʙʏ DILISHA ᴛᴇᴄʜ*` ,

  ALIVE_IMG: process.env.ALIVE_IMG || "https://telegra.ph/file/67df6124e5ea42d98946f.jpg",
  MENU_IMG: process.env.MENU_IMG || "https://telegra.ph/file/67df6124e5ea42d98946f.jpg",
